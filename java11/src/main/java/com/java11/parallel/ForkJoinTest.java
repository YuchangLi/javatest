...
public class ForkJoinTest extends java.util.concurrent.RecursiveTask<Long> {
  ...
  public static void main(String[] args) {
    ...
    long sumValue = forkJoinSum(10_000_000);
    System.out.println("sum  = " + sumValue+" time = "+(System.currentTimeMillis() - t1)+", nanotime = "+(System.nanoTime()-t2));
  }
